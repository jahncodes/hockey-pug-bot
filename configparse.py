...
lobbyPassword = config['slapshot']['lobby_password']
...
arrowDownRed = config['discord_embed']['arrowdown_emoji_red']
arrowDownGreen = config['discord_embed']['arrowdown_emoji_green']